...
public interface ProductsApi {
    ...
    default ResponseEntity<ProductDto> getProductById(
        @Parameter(name = "productId", description = "The id of the product to retrieve", required = true, schema = @Schema(description = "")) @PathVariable("productId") Integer productId
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"image\" : \"image\", \"productQuantity\" : 7, \"price\" : 2.3021358869347655, \"name\" : \"name\", \"id\" : 5 }";
    ...
    default ResponseEntity<ProductDto> updateProductQuantity(
        @Parameter(name = "productId", description = "The ID of the product", required = true, schema = @Schema(description = "")) @PathVariable("productId") Integer productId,
